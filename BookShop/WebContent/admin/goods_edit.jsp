...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="../admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">Store</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name" name="stock" value="${g.stock }">
			</div>
		</div>
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Picture</label>
		...
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Picture 1</label>
		...
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Picture 2</label>
